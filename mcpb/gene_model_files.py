...
#                             write_gms_mkf)
#from pymsmt.mol.nwchemio import (write_gmsatm, write_gms_optf, write_gms_fcf,
#                             write_gms_mkf)
#from pymsmt.mol.sqmio import get_crdinfo_from_sqm, write_sqm_optf
#from pymsmt.lib import get_lib_dict

# pyMSMT importing (new)
from mol.pdbio import get_atominfo_fpdb, writepdbatm
from mol.cal import calc_bond
from mol.mol import pdbatm, gauatm, get_reslist
from mol.getlist import get_blist
from mol.element import (Atnum, CoRadiiDict,                  
                         get_ionljparadict, AtnumRev, bdld)
from mol.gauio import (write_gauatm, write_gauatm_opth, write_gau_optf,                 
                       write_gau_fcf, write_gau_mkf)
...
from exp import pymsmtError, pymsmtWarning
...
def build_small_model(mol, reslist, ionids, cutoff, smresids, smresace,
    ...
    #GAMESS
    nwcoptf = outf + '_small_opt.nwi'
    nwcfcf  = outf + '_small_fc.nwi'
    ...
    #NWChem
    write_nwchem_optf(nwcoptf, smchg, SpinNum, gatms)
    write_nwchem_fcf(nwcfcf, smchg, SpinNum)
...
def build_large_model(mol, reslist, lmsresids, lmsresace, lmsresnme,
    ...
    #For NWChem file
    write_nwchem_mkf(nwcf, lgchg, SpinNum, gatms, largeopt)
